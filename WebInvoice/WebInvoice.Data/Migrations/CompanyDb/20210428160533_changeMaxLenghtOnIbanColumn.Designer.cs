...
namespace WebInvoice.Data.Migrations.CompanyDb
{
    ...
    [Migration("20210428160533_changeMaxLenghtOnIbanColumn")]
    partial class changeMaxLenghtOnIbanColumn
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebInvoice.Data.CompanyData.Models.NonVatDocument", b =>
                {
                    ...
                    b.Property<byte[]>("AllDocumentData")
                        .HasColumnType("varbinary(max)");
            ...
            modelBuilder.Entity("WebInvoice.Data.CompanyData.Models.PaymentType", b =>
                {
                    ...
                    b.Property<bool>("RequireBankAccount")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("WebInvoice.Data.CompanyData.Models.Sales", b =>
                {
                    b.HasOne("WebInvoice.Data.CompanyData.Models.FreeProduct", "FreeProduct")
                        .WithMany()
